        ...
        <ul class="navbar-nav my-3 mx-4" style="float:right">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('form-admin') }}">Data Peminjaman</a></li>
                    ...
                    <div class="card-body">
                        ...
                        @csrf 
                            ...
                            <div class="form-group mb-4">
                                <input type="date" name="tglpinjam" id="tglpinjam" class="form-control @error('nama') is-invalid @enderror" placeholder="Tanggal Pinjam">
                                @error('tglpinjam')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
